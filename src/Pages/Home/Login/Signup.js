             ...
             {...register("password", {
                ...
                {errors.password?.type === 'required' && <span className="label-text-alt text-red-500">{errors.password.message}</span>}
                 {errors.password?.type === 'minLength' && <span className="label-text-alt text-red-500">{errors.password.message}</span>}
                        ...
                        {signInError}
                <input className='btn w-full btn-secondary max-w-xs text-white' type="submit" value="SignUp" />
                    </form>
                     <p className='pl-10 pt-3'><small>Already have an account? <Link className='text-primary' to="/login">Please Login</Link></small></p>
